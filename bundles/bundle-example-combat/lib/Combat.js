...
class Combat {
  ...
  static normalizeWeaponDamage(attacker, amount) {
    //let damroll = attacker.addAttribute('damroll');
    ...
    // Now, add on any additional damroll that they have - range between 75% and 125%
    amount += Random.inRange( (damroll * 0.75), (damroll *1.25));
